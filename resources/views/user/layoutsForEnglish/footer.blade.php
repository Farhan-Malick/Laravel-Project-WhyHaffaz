<section id="footer" class="footer">
        ...
        <div class="row">
            <div class="col-12 col-md-8 offset-md-2">
                <div class="text-center">
                    ...
                    <p>Hafez is an integrated electronic platform for distance learning teaching and memorization of the
                        Noble Quran, as we connect those who wish to memorize the Quran everywhere with a distinguished
    ...
    <div class="py-3">
        <div class="col-12 text-center">
            <h6 class="text-white">Haffez Quran - All Rights Reserved - Design & Developed By Artivay & CDOXS</h6>
        </div>
    </div>
