        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title text-lg float-left col-md-12" >
                    ...
                    <a  class="float-right btn btn-danger" href="{{ URL('/admin/arabicadmin/contact/list')}}">Back</a>
                </h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <div class="tab-content p-0">
                    <form action="{{ url('/admin/arabicadmin/contact/update/'.$con_result['0']->id)}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="card-body">
