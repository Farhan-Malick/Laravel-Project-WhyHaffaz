                    ...
                    <form action="{{ url('/admin/post/submit')}}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="card-body">
                          <div class="form-group">
                            ...
                            <input type="text" name="title2" class="form-control" id="exampleInputTitle" placeholder="Enter Title 2" data-parsley-lenght="[10,30]" data-parsley-pattern="[a-zA-Z ]+$" data-parsley-trigger="keyup">
                            @error('title2')
                                <span>{{ $message }}</span>
                            @enderror
                          </div>
                          <div class="form-group">
                            ...
                            <textarea class="form-control" name="description2" id="" cols="30" rows="10" placeholder="Description 2"  data-parsley-lenght="[100,160]" data-parsley-trigger="keyup"></textarea>
                            @error('description2')
                                <span>{{ $message }}</span>
                            @enderror
                          </div>
