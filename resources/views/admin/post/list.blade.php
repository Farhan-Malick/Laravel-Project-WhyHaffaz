    ...
    <div class="content-wrapper">
        ...
        <div class="card">
            <div class="card-header">
                <h2>Home Section</h2>
                <div class="col-sm-12" style="text-align: center; color:green; font-size:20px">{{ session('msg') }}
                </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($result as $list)
                                <tr>
                                    ...
                                    <td><img src="{{ asset('storage/app/public/post/home/' . $list->image) }}"
                                            width="150px" />
                                    </td>
                                    <td><img src="{{ asset('storage/app/public/post/secondbanner/' . $list->image2) }}"
                                            width="150px" /></td>
