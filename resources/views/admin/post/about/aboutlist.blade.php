              ...
              <?php  
               ...
               ?>
                 ...
                 <tr>
                  ...
                  <td>
                     <a  class="btn btn-primary" href="{{URL('/admin/post/about/aboutedit/'.$aboutlist->id)}}">Edit</a>
                     <a  class="btn btn-danger" href="{{URL('/admin/post/delete'.$aboutlist->id)}}" >Delete</a>
                  </td>
                </tr>
                 @endforeach
                </tbody>
