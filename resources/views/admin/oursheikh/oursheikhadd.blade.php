        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="tab-content p-0">
                    <form action="{{ URL('/admin/oursheikh/oursheikhsubmit')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <textarea class="form-control" name="description2" id="" cols="30" rows="10" placeholder="Description "></textarea>
                            @error('description2')
                                <span>{{ $message }}</span>
                            @enderror
                          </div>
