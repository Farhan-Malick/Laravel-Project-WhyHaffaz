...
<div class="content-wrapper">
    ...
    <div class="card">
        ...
        <!-- <div class="card-header ">
          <a  class="btn btn-success " href="{{ URL('/admin/oursheikh/oursheikhadd')}}">Add Post</a>
         </div> -->
        <!-- /.card-header -->
        <div class="card-body  ">
              ...
              <?php  
               ...
               ?>
                 ...
                 <tr>
                     <td>{{$list->id}}</td>
                     <td>{{$list->heading}}</td>
                     <td class="toggle-text" >{{Str::limit($list->description1, 60)}}
                     <td class="toggle-text" >{{Str::limit($list->description2, 60)}}
                  <td>
                     <a  class="btn btn-primary" href="{{('/haffiz/admin/oursheikh/oursheikhedit/'.$list->id)}}">Edit</a>
                     <a  class="btn btn-danger" href="{{('/haffiz/admin/oursheikh/delete'.$list->id)}}" >Delete</a>
                  </td>
                </tr>
                 @endforeach
                </tbody>
    ...
    <div class="card">
               ...
               <table id="myTable" class="table table-bordered table-striped table-responsive-xl" >
                 ...
                 <tr>
                     ...
                     <td>{{$list->fname}}</td>
                     <td>{{$list->lname}}</td>
                     <td><img src="{{ asset('storage/app/public/post/oursheikhs/'.$list->image) }}" width="150px" height="100px"/></td>
                  <td>
                     <a  class="btn btn-primary" href="{{('/haffiz/admin/oursheikh/oursheikhpart/oursheikhedit/'.$list->id)}}">Edit</a>
                     <a  class="btn btn-danger" href="{{('/haffiz/admin/oursheikh/oursheikhpart/delete'.$list->id)}}" >Delete</a>
                  </td>
                </tr>
                 @endforeach
                  </tr>
